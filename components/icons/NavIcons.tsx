...
export function SensorsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M12 1a8 8 0 0 0-8 8c0 2.52 1.17 5.1 2.73 7.35.78 1.13 1.66 2.18 2.54 3.1.44.46.87.88 1.27 1.25.2.19.39.36.56.5.08.07.2.17.35.28.1.07.29.2.55.32.26.12.58.2.93.2h.14c.35 0 .67-.08.93-.2.26-.12.45-.25.55-.32.15-.11.27-.21.35-.28.17-.14.36-.31.56-.5.4-.37.83-.79 1.27-1.25.88-.92 1.76-1.97 2.54-3.1C18.83 14.1 20 11.52 20 9a8 8 0 0 0-8-8Zm0 12a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z" />
    </svg>
  );
}
...
export function MapIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M8.161 2.58a1.875 1.875 0 0 1 1.678 0l4.993 2.498c.106.052.23.052.336 0l3.869-1.935A1.875 1.875 0 0 1 21.75 4.82v12.485a1.875 1.875 0 0 1-1.037 1.677l-4.875 2.437a1.875 1.875 0 0 1-1.676 0L9.17 18.92a.375.375 0 0 0-.336 0l-3.869 1.935A1.875 1.875 0 0 1 2.25 19.18V6.695c0-.726.42-1.387 1.037-1.677l4.875-2.437ZM9 6a.75.75 0 0 1 .75.75V15a.75.75 0 0 1-1.5 0V6.75A.75.75 0 0 1 9 6Zm6.75 3a.75.75 0 0 0-1.5 0v8.25a.75.75 0 0 0 1.5 0V9Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function RolesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
